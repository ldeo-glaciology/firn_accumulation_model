...
save results_for_figure_1_v2 p delta Ar Pe
% load results_for_figure_1_v2 p delta Ar Pe
...
title(ax1,'firn compaction number, $\alpha$')
ylim(ax1,[1e-2, 1])
xlim(ax1,[233 273.15])
...
title(ax2,'logarithm of grain size saturation parameter, log$_{10}\delta$')
ylim([1e-2, 1])
xlim([233 273.15])
